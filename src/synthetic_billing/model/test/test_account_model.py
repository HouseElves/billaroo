...
class TestBuildAccountHappyPath:
    ...
    def test_returns_account(self) -> None:
        ...
        acct = build_account(seed=42, account_ordinal=0, billing_cycle_day=15,
                             region_code="US-WEST")
    ...
    def test_ordinal_stored(self) -> None:
        ...
        acct = build_account(seed=42, account_ordinal=7, billing_cycle_day=1,
                             region_code="EU")
...
class TestBuildAccountIdDerivation:
    ...
    def test_id_matches_derive_id(self) -> None:
        ...
        acct = build_account(seed=42, account_ordinal=3, billing_cycle_day=15,
                             region_code="US-WEST")
    ...
    def test_deterministic_across_calls(self) -> None:
        ...
        first = build_account(seed=1, account_ordinal=0, billing_cycle_day=10,
                              region_code="AP")
        second = build_account(seed=1, account_ordinal=0, billing_cycle_day=10,
                               region_code="AP")
        assert first.account_id == second.account_id

    def test_different_seeds_different_ids(self) -> None:
        """Different seeds produce different account IDs."""
        a = build_account(seed=1, account_ordinal=0, billing_cycle_day=10,
                          region_code="AP")
        b = build_account(seed=2, account_ordinal=0, billing_cycle_day=10,
                          region_code="AP")
        assert a.account_id != b.account_id

    def test_different_ordinals_different_ids(self) -> None:
        """Different ordinals produce different account IDs."""
        a = build_account(seed=42, account_ordinal=0, billing_cycle_day=10,
                          region_code="AP")
        b = build_account(seed=42, account_ordinal=1, billing_cycle_day=10,
                          region_code="AP")
        assert a.account_id != b.account_id
...
class TestBuildAccountValidation:
    ...
    def test_rejects_invalid_billing_cycle_day(self) -> None:
        ...
        with pytest.raises(ValueError, match="billing_cycle_day"):
            build_account(seed=42, account_ordinal=0, billing_cycle_day=0,
                          region_code="US")

    def test_rejects_invalid_status(self) -> None:
        """An unknown status is rejected by the Account contract."""
        with pytest.raises(ValueError, match="account_status"):
            build_account(seed=42, account_ordinal=0, billing_cycle_day=15,
